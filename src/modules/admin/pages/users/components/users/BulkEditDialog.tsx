...
import type { UserFormData } from "@/modules/admin/schemas/users.schema"
...
const BulkEditDialog = ({ isLoading, isOpen, selectedUsers, users, onClose, onUpdate }: BulkEditDialogProps) => {
    const [tabs, setTabs] = useState<Array<{ id: string; user: any; title: string }>>([])
