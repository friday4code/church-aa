// components/regions/components/RegionsTableLoading.tsx
"use client"
...
interface RegionsTableLoadingProps {
    rows?: number
}

const RegionsTableLoading = ({ rows = 5 }: RegionsTableLoadingProps) => {
    return (
                ...
                <Table.Body>
                    {Array.from({ length: rows }).map((_, index) => (
                        <Table.Row key={index} bg="whiteAlpha.500">
                            ...
                            <Table.Cell>
                                <Skeleton height="16px" width="50px" rounded="md" />
                            </Table.Cell>
                            <Table.Cell>
...
export default RegionsTableLoading